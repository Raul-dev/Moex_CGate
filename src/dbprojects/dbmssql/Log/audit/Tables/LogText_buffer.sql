CREATE TABLE [audit].[LogText_buffer] (
    ...
    CONSTRAINT [PK_audit_AuditLT_buffer] PRIMARY KEY CLUSTERED ([buffer_id] ASC) WITH (ALLOW_PAGE_LOCKS = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = ON)
);
